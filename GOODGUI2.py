...
class secondpage():
    ...
    def __init__(self,root,myTitle,flag):    
        ...
        def OutputInform():
            ...
            hh=str(a[7])
            ii=str(a[8])
            ShowContract1=Label(win,font=('微軟正黑體 bold',20),anchor=W,justify='left',bg='steel blue',text="買家:"+aa+"\n\n賣家:"+bb+"\n\n金額："+cc+"\n\n時間："+dd+"\n\n出貨港："+ee+"\n\n到貨港："+ff+"\n\n其他細節："+gg+"\n\n訂金："+hh+"\n\n尾款："+ii)
        ...
        Myaddr = Label(win,anchor=W,justify='left',bg='gray20',font=('微軟正黑體 bold',16), text = MyaddrText)
